...
def setup_weather_data_crawler():
    crawler_name = 'weather_data_crawler_silver_layer'
    s3_target_path = f's3://weather-influence-on-sales/silver/weather/date_key={current_date}/' # S3 path where weather data is stored
